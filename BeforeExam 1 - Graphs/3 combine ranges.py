# Given set of ranges [ai, bi]. Two ranges can be combined if they have exactly one common point. Find algorithm
# that checks if it is possible to get range [a, b] by combining ranges together.
